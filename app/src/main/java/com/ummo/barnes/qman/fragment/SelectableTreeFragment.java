...
import com.ummo.barnes.qman.MyAdapter;
import com.ummo.barnes.qman.R;
import com.ummo.barnes.qman.db.Db;
import com.ummo.barnes.qman.holder.IconTreeItemHolder;
import com.ummo.barnes.qman.holder.MaterialLetterIconTreeItemHolder;
import com.ummo.barnes.qman.holder.ProfileHolder;
import com.ummo.barnes.qman.holder.SelectableHeaderHolder_2;
import com.ummo.barnes.qman.holder.SelectableItemHolder;
import com.ummo.barnes.qman.ummoAPI.QUser;
import com.ummo.barnes.qman.ummoAPI.QUserListner;
...
public class SelectableTreeFragment extends BaseActivity implements SheetLayout.OnFabAnimationEndListener, QUserListner
{
    ...
    protected void onCreate(final Bundle savedInstanceState)
    {
        ...
        */
        ...
        if(mess==null){
            mess = PreferenceManager.getDefaultSharedPreferences(this).getString(getString(R.string.PREF_CATEGORIES_JSON),"NULL");

        }

        else {
            PreferenceManager.getDefaultSharedPreferences(this).edit().putString(getString(R.string.PREF_CATEGORIES_JSON),mess).apply();
        }
        //Log.e("Greeting",mess);
    ...
    //activity.registerReceiver(broadcastReceiver, new IntentFilter("com.ummo.barnes.qman.CATEGORIES"));
    //return rootView;
