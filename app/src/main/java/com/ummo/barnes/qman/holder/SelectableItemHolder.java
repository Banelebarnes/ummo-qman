package com.ummo.barnes.qman.holder;
...
public class SelectableItemHolder extends TreeNode.BaseNodeViewHolder<String>
{
    ...
    public void dialog()
    {
        ...
        new CountDownTimer(800 * 7, 800)
        {
            ...
            {
                String text = SelectableItemHolder.this.parent.getqJSON();
                if(text==null){
                    this.start();
                    return;
                }
                ...
                pDialog.setTitleText(selecHeader + " Queue")
                        .setContentText(
                                "Location of service : ".toUpperCase() + city +"\n"+
                                    ...
                                    public void onClick(SweetAlertDialog sDialog) {
                                        ...
                                        if (qNameList.isEmpty())
                                        {
                                            ...
                                            sDialog.setTitleText("Queued in...")
                                                    ...
                                                    .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                                        ...
                                                        public void onClick(SweetAlertDialog sDialog) {
                                                            ...
                                                            tabTitle = selecHeader + " " + text_;
                                                            qNameServiceId = db.getQService_id(text_);
                                            ...
                                            pDialog.setTitleText("Exit Queue")
                                                    .setContentText("You are already queued in to this que. Do you want to exit the " + selecHeader + " " + text_ + " queue")
                                                    .setConfirmText("yes")
                                                    .showCancelButton(true)
                                                    .setCancelClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                                        @Override
                                                    ...
                                                    .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                                        @Override
                                                        public void onClick(SweetAlertDialog sDialog) {
                                                            qJoinedQid = db.getJoinedQ_id(text_);
    ...
    public View createNodeView(final TreeNode node, String value)
    {
        ...
        try {
            nodeSelector.setChecked(((SelectableTreeFragment)context).getUser().isQJoined(vq.getString("Id")));
        }
        catch (JSONException jse){
            Log.e("NODECREATE",jse.toString());
